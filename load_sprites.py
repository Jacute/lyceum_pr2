...
sprite_dio_walking_right1 = [load_image('dio_walking_right1.png'),
                             load_image('dio_walking_right2.png'),
                             load_image('dio_walking_right3.png'),
                             load_image('dio_walking_right4.png'),
                             load_image('dio_walking_right5.png'),
                             load_image('dio_walking_right6.png'),
                             load_image('dio_walking_right7.png'),
                             load_image('dio_walking_right8.png')]
sprite_dio_walking_right2 = [load_image('dio_walking_right9.png'),
                             load_image('dio_walking_right10.png'),
                             load_image('dio_walking_right11.png'),
                             load_image('dio_walking_right12.png'),
                             load_image('dio_walking_right13.png'),
...
sprite_dio_jumping = [load_image('dio_jump1.png'), load_image('dio_jump2.png'),
                      load_image('dio_jump4.png'), load_image('dio_jump5.png'),
                      load_image('dio_jump6.png'), load_image('dio_jump7.png'),
